                            ...
                            <form action="insert.php" method="post" id="forme">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="zonal" id="myzonal"class="form-control">
                                        ...
                                        <option value="Christ Embassy LCA Car Park">Christ Embassy LCA Car Park</option>
                                        <option value="Christ Embassy Lekki Church">Christ Embassy Lekki Church</option>
                                        <option value="Love World Arena - Christ Embassy Lekki">Love World Arena - Christ Embassy Lekki</option>
                                        <option value="Christ Embassy Orile 1">Christ Embassy Orile 1</option>
...
<!--                                        <button type="submit" name="submit" class="fxt-btn-fill">Log in</button>-->
    ...
    <script>
        ...
        function payWithKingsChat(){
            ...
            if(title != "" && first != "" && surname != "" && email != "" && phone != "" && partner != "" && zonal != "" && member != "" && amount != "") {
